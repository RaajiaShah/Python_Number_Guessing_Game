...
normal = Toplevel()
normal.config(bg="#000000")
normal.geometry('500x600')
normal.title("Number Guessing Game - Normal Level")
normal.resizable(width=False, height=False)
...
normal.iconphoto(False, icon)

# heading  
Label(normal, text="Number Guessing Game", bg="#ffd902",
      fg="#FFFBF5", font="cambria 24 bold", width=29).pack()

# logo image
my_img = PhotoImage(file = "images/logo2.png") 
l2 = Label(normal,  image=my_img )
l2.pack(pady=10)

# entry
number_form = Entry(normal,font="Arial 20", width=20,bg="#000000",fg="#FFFBF5",insertbackground='white')

# buttons
guessed_btn = Button(normal,text="Guess",font="cambria 16 bold", bg="#FFBF00",
        fg="#FFFBF5", activebackground="#D4A007", activeforeground="#FFFBF5", command=play_game)
exit_btn = Button(normal,text="Exit",font="cambria 18 bold", bg="#FFBF00",
       fg="#FFFBF5", activebackground="#D4A007", activeforeground="#FFFBF5", width=20 ,command=openHomePage)


# guess result
result = Label(normal, text="Guess a number between 0 and 500", bg="#FFBF00",fg="#FFFBF5",
